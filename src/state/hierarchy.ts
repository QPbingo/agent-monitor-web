...
export interface Story { id: number; topic_id: number; name: string; description: string; session_key: string; agent_profile_id?: number | null; latest_run_id?: number | null; latest_session_key?: string; latest_run_status?: string; status: string; created_at: number; updated_at: number }
